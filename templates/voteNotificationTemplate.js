const voteNotificationTemplate = `
<!DOCTYPE html>
															...
															<td class="pad">
																<div style="font-family: Tahoma, Verdana, sans-serif">
																	<div class style="font-size: 12px; font-family: Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
																		<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><strong>{{title}}</strong></p>
																	</div>
																</div>
															</td>
														</tr>
												...
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 20px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="paragraph_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														...
														<td class="pad" style="padding-bottom:5px;padding-left:60px;padding-right:60px;padding-top:5px;">
															<div style="color:#878787;direction:ltr;font-family:Tahoma, Verdana, Segoe, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																<p style="margin: 0;">
																	We’re excited to inform you that your Delegate <strong><a href="https://app.chora.club/{{content.chain}}/{{content.voter}}?active=info" style="color:#007bff;text-decoration:underline;">{{content.shortVoter}}</a></strong> 
																	has cast their vote on your behalf for Proposal ID: <a href="https://app.chora.club/{{content.chain}}/proposals/{{content.proposalId}}" style="color:#007bff;text-decoration:underline;">
																	<strong>{{content.shortProposalId}}</strong></a> in the {{content.chain}}.
																</p>
																<p style="margin: 0; bold">Decision Made by Your Delegate: <strong>{{VoteContent}}</strong></p>
																<p style="margin: 0;">{{endContent}}</p>
															</div>
														</td>
														</tr>
...
module.exports = { voteNotificationTemplate };
